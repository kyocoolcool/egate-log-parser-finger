...
public class LogToExcel_R1F5 implements AutoCloseable {
...
//	private static final int[] styleBColumn = {1, 5, 7, 8, 11, 12, 13, 18, 19, 20, 24, 25, 26, 30, 31, 32};
	...
	public LogToExcel_R1F5() {
		wb = new SXSSFWorkbook();
	}
	
	public LogToExcel_R1F5(SXSSFWorkbook wb) {
		this.wb = wb;
	}
