...
public class LogToExcel_V41 implements AutoCloseable {
...
//	private static final int[] styleBColumn = {1, 5, 7, 8, 11, 12, 13, 18, 19, 20, 24, 25, 26, 30, 31, 32};
	...
	public LogToExcel_V41() {
		wb = new SXSSFWorkbook();
	}
	
	public LogToExcel_V41(SXSSFWorkbook wb) {
		this.wb = wb;
	}
...
//		sheet.addMergedRegion(new CellRangeAddress(rowIndex-1, rowIndex, 33, 33));
	...
	private Object[] beanValueToArray(PassengerLog u) {
		...
		arr[idx++] = CommonUtils.decimalRoundD(u.getReportACE1E2FSeconds(), 3); //第三代自動通關系統所需時間 A+C+D	
		...
		arr[idx++] = CommonUtils.decimalRoundD(u.getFaceNoResultSecs(), 3); //臉部擷取時間-秒數E11
		arr[idx++] = CommonUtils.decimalRoundD(u.getFaceHasResultSecs(), 3); //臉部辨識時間-秒數E12
		...
		arr[idx++] = CommonUtils.calculateSecond(u.getReportASeconds(), u.getFaceNoResultSecs(), u.getFaceHasResultSecs(), u.getFingerPressNoResultSecs(), u.getFingerPressHasResultSecs(), u.getReportFSeconds()) > 10.0 ? 
				CommonUtils.decimalRoundD(CommonUtils.calculateSecond(u.getReportASeconds(), u.getFaceNoResultSecs(), u.getFaceHasResultSecs(), u.getFingerPressNoResultSecs(), u.getFingerPressHasResultSecs(), u.getReportFSeconds()), 3) : null; //第三代自動通關系統所需時間 A + E11 + E12 + E21 + E22 + F >10
		arr[idx++] = "";
